...
def train_model(model, criterion, optimizer, scheduler, dataloaders, dataset_sizes, num_epochs=100):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            running_loss = 0.0
            running_corrects = 0
            incorrect_preds = []  # List to store incorrect predictions
            incorrect_labels = []  # List to store real labels of incorrect predictions
            ...
            for inputs, labels in tqdm(dataloaders[phase]):
                ...
                if phase != 'train':
                  ...
                  incorrect_preds.extend(preds[incorrect_mask])
                  incorrect_labels.extend(labels.data[incorrect_mask])
        ...
        # print([(int(pred), int(label)) for pred, label in zip(incorrect_preds, incorrect_labels)])
        # print()
